...
class TimeDate :
    ...
    # Creates an object instance for the specified Gregorian date and time.
    def __init__( self, month = None, day = None, year = None, hours = None, minutes = None, seconds = None ) :

        # If any of the arguments is not given in the constructor, initialize the date
        # to the current date.
        if not month or not day or not year or not hours or not minutes :
            today = datetime.datetime.today()
            month, day, year, hours, minutes, seconds = today.month, today.day, today.year, today.hour, today.minute, today.second
    ...
    def advanceBy( self, numDays ) :
        ...
        return TimeDate( month, day, year, self.hours(), self.minutes(), self.seconds() )
    ...
    def asGregorian( self, divchar = '/' ) :
        month, day, year = self._toGregorian()
        return "%02d%s%02d%s%04d  %02d:%02d:%02d" % ( month, divchar, day, divchar, year, self.hours(), self.minutes(), self.seconds() ) 
    ...
    def __str__( self ) :
        month, day, year = self._toGregorian()
        return "%02d/%02d/%04d  %02d:%02d:%02d" % ( month, day, year, self.hours(), self.minutes(), self.seconds() )
